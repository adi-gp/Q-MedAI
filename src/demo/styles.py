...
.stApp { color: var(--qm-navy); background: linear-gradient(145deg, #F7FBFF 0%, #EEF6FF 55%, #F7F4FF 100%); }
...
.qm-card { color: var(--qm-navy); background: #ffffffd9; border: 1px solid #D8E8F5; border-radius: 18px;
  padding: 1rem 1.1rem; min-height: 132px; box-shadow: 0 8px 24px #17324d12; }
.qm-verdict { color: var(--qm-navy); border-left: 5px solid var(--qm-cyan); background: white; padding: .85rem 1rem; border-radius: 12px; }
